...
import "../styles/analytics.css"; // Ensure to import your CSS file

const Analytics = ({ allTransection }) => {
    const categories = [
        "salary", "bonus", "project", "food", "movie", 
        "shopping", "bills", "medical", "fees", "tax", 
        "house rent"
    ];

    // Total transactions and calculations
            ...
            <div className="analytics-container">
                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        {categories.map(category => {
                            const amount = allTransection.filter(transaction => transaction.type === "expense" && transaction.category === category)
                                .reduce((acc, transaction) => acc + transaction.amount, 0);
                            return (
                                amount > 0 && (
                                    <div key={category} className="mb-2">
